...
from recommender.forms import UserForm,UserProfileInfoForm,UserUpdateInfoForm
...
def update_profile(request,id):
    ...
    if request.method == "POST":
        user_form = UserUpdateInfoForm(request.POST,instance=User.objects.get(pk=int(id)))
        p_id = request.user.profile.id
        profile_form = UserProfileInfoForm(request.POST,instance=Profile.objects.get(pk=int(p_id)))
        ...
        user_form = UserUpdateInfoForm(instance=User.objects.get(pk=int(id)))
        p_id = request.user.profile.id
        profile_form = UserProfileInfoForm(instance=Profile.objects.get(pk=int(p_id)))
